            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="products" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td style="vertical-align:middle;">{{ $sn }} <br> {{ $product->id }} </td>
                    ...
                    <td style="vertical-align:middle;">
                      <span class="btn-group" role="group">
                        <span class="btn btn-sm btn-warning">
                          @if($product->status ==1)
                            <a class="updateProductStatus" id="product-{{ $product->id }}" product_id="{{ $product->id }}" href="javascript:void(0)"><i class="fas fa-toggle-on" aria-hidden="true" title="Active" status="Active"></i></a>
                          @else
                            <a class="updateProductStatus" id="product-{{ $product->id }}" product_id="{{ $product->id }}" href="javascript:void(0)"><i class="fas fa-toggle-off" aria-hidden="true" title="Inactive" status="Inactive"></i></a>
                          @endif
                        </span>
                        &nbsp;
                        ...
                        &nbsp;
                        <a href="{{ url('admin/add-images/'.$product->id) }}" class="btn btn-sm btn-warning" title="Add Product Image"><i class="fas fa-plus-circle"></i></a>
                        &nbsp;
